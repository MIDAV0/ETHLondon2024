...
// const NetworkConfigurations = [CeloAlfajoresConfig, ArbitrumSepoliaConfig, BaseSepoliaConfig];
...
// const burn = async (
//   ethTokenMessengerContract: any,
//   amount: string,
//   destinationDomain: number,
//   destinationAddressInBytes32: string,
//   usdcEthContractAddress: string,
//   web3: Web3,
// ) => {
//   const burnTxGas = await ethTokenMessengerContract.methods
//     .depositForBurn(amount, destinationDomain, destinationAddressInBytes32, usdcEthContractAddress)
//     .estimateGas();
...
//   messageTransmitterContract: any,
//   messageBytes: string,
...
//   const usdcSourceContract = getContract(
//     web3,
//     usdcAbi,
//     sourceNetworkConfig.USDC_CONTRACT_ADDRESS,
//     sourceSigner.address,
//   );
//   const sourceTokenMessengerContract = getContract(
//     web3,
//     tokenMessengerAbi,
//     sourceNetworkConfig.TOKEN_MESSENGER_CONTRACT_ADDRESS,
//     sourceSigner.address,
//   );
//   const sourceMessageContract = getContract(
//     web3,
//     messageAbi,
//     sourceNetworkConfig.MESSAGE_CONTRACT_ADDRESS,
//     sourceSigner.address,
//   );
...
//     sourceTokenMessengerContract,
//     amount,
//     destinationNetworkConfig.DESTINATION_DOMAIN_ID,
...
//   const destinationMessageTransmitterContract = getContract(
//     web3,
//     messageTransmitterAbi,
//     destinationNetworkConfig.MESSAGE_CONTRACT_ADDRESS,
